...
- **Welcome wizard** on first launch with three skippable steps for voice / speech / tutor setup.
...
- Mistake counter is **per-lesson, in-memory only**, so it resets on lesson change and the drill sergeant rage doesn't carry over.
